...
This repo contains Terraform files to deploy all Azure network components needed to deploy Nutanix Cloud Cluster(NC2) on Azure Baremetal. This branch include a n Azure vWAN vHub, a VNet to simulate an On Prem network, a Site to Site VPN between on premises and vHub.

------------------------------------------

-------- :construction: DON'T USE IT RIGHT NOW !!!!!! :construction: -------
